INSERT INTO `store_db`.`customers` (`customer_id`,`fName`, `lName`, `age`, `email`, `password`,`address`,`postcode`) VALUES (1,'jordan', 'harrison',22,'ll@qa.com','dgsfhaf8g','343 fasd sf','DC3 4rd');
